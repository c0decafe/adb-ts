...
var __1 = require("../..");
var DisconnectCommand = (function (_super) {
    ...
    DisconnectCommand.prototype.execute = function (host, port) {
        var _this = this;
        return _super.prototype.execute.call(this, "host:disconnect:" + host + ":" + port)
            .then(function (reply) {
            switch (reply) {
                case __1.Reply.OKAY:
                    return _this.parser.readValue().then(function (value) {
                        var regExp = /disconnected/;
                        if (regExp === null || regExp === void 0 ? void 0 : regExp.test(value.toString())) {
                            return host + ":" + port;
                        }
                        else {
